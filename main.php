                ...
                <?php
                    ...
                    if($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo 
                            "<td>". 
                                "<form method='post' action='main-process-delete.php' onsubmit='return delete_validate()'>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo htmlspecialchars('main-process-insert.php'); ?>" method="post" onsubmit='return validate4()'>
